export default class Store extends Phaser.Physics.Arcade.Sprite {
    constructor(scene, x, y,texture,frame) {
        ...
        this.price_hp = scene.add.text(642, scene.map.heightInPixels-105, 'x'+coin, {fontSize:'15px', fill:'#ffffff'}).setVisible(false).setScrollFactor(0);
        ...
        this.price_hp1 = scene.add.text(642, scene.map.heightInPixels-75, 'x'+coin, {fontSize:'15px', fill:'#ffffff'}).setVisible(false).setScrollFactor(0);
        ...
        this.price_hp2 = scene.add.text(642, scene.map.heightInPixels-50, 'x'+coin, {fontSize:'15px', fill:'#ffffff'}).setVisible(false).setScrollFactor(0);
